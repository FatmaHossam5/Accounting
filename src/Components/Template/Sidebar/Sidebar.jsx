                        ...
                        <ul className="mt-3">
                            ...
                            <li className='side-link'>
                                <div className="d-flex pt-2 pb-2  align-items-center">
                                    ...
                                    <span className={`side-text ${collapsed ? 'd-none' : ''} ${path === '/Cities' ? 'active-side-link' : ''}`}>
                                        <Link to="Cities"
                                            className="side-link px-gray-text"
                                            onClick={() => handleItemClick('Cities')}
                                        >
                                            <p className="side-text ">Cities</p>
                                        </Link>
                                    </span>
                                </div>
                            </li>
                            <li className='side-link'>
                                <div className="d-flex pt-2 pb-2  align-items-center">
                                    ...
                                    <span className={`side-text ${collapsed ? 'd-none' : ''} ${path === '/Industries' ? 'active-side-link' : ''}`}>
                                        <Link to="Industries"
                                            className="side-link px-gray-text"
                            ...
                            <li className='side-link'>
                                <div className="d-flex pt-2 pb-2  align-items-center">
                                    ...
                                    <span className={`side-text ${collapsed ? 'd-none' : ''} ${path === '/Departments' ? 'active-side-link' : ''}`}>
                                        <Link to="Departments"
                                            className="side-link px-gray-text"
                            ...
                            <li className='side-link'>
                                <div className="d-flex pt-2 pb-2  align-items-center">
                                    ...
                                    <span className={`side-text ${collapsed ? 'd-none' : ''} ${path === '/Categories' ? 'active-side-link' : ''}`}>
                                        <Link to="Categories"
                                            className="side-link px-gray-text"
                            ...
                            <li className='side-link'>
                                <div className="d-flex pt-2 pb-2  align-items-center">
                                    ...
                                    <span className={`side-text ${collapsed ? 'd-none' : ''} ${path === '/Taxs' ? 'active-side-link' : ''}`}>
                                        <Link to="Taxs"
                                            className="side-link px-gray-text"
                                            onClick={() => handleItemClick('Taxs')}
                                        >
                                            <p className="side-text ">Tax</p>
                                        </Link>
                                    </span>
                                </div>
                            </li> */}
