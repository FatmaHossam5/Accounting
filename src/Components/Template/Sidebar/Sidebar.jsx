...
export default function Sidebar({ collapsed, toggleSidebar }) {
    ...
    ,{name:'settinges' ,paths:['/Countries','/Governarates','/Cities','/Industries','/Departments','/Categories','/Taxs'],icon: (<svg width={24} height={24} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
