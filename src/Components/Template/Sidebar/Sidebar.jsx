                            ...
                            <li className="side-drop-down ">
                                <div className="accordion " id="accordionExample">
                                    <div className="accordion-item ">
                                        <h2 className="accordion-header  ">
                                            <button
                                                className={`accordion-button  side-link  text-capitalize  pe-2 ${activeItem === 'services' ? 'active-side-link' : ''}`}
                                                type="button" data-bs-toggle="collapse"
                                                data-bs-target="#collapseOne" aria-expanded="true"
                                                aria-controls="collapseOne"
                                            ...
                                            >
                                                <div className="d-flex pt-2 pb-2 justify-content-center align-items-center ">
                                                    ...
                                                    <span className={`side-text ${collapsed ? 'd-none' : ''} ${activeItem === 'services' ? "active-side-link" : ''}`} onClick={() => handleItemClick('services')}>
                                                        Services and Products
                                                    </span>
                                                </div>
                                            </button>
                                ...
                                <div className="accordion " id="accordionExample">
                                    <div className="accordion-item ">
                                        ...
                                        <div id="collapseOne" className={`accordion-collapse collapse ${collapsed ? 'd-none' : ''}`}
                                            ...
                                            <div className="accordion-body px-accordion-body">
                                                <ul className="nav-treeview" >
                                                    <li className={`${activeItem === 'customers' ? 'active-sub-link' : ''}  ${pathname === '/' ? 'active-sub-link' : ''} `}>
                                                        <Link to="/"
                                                            className="side-link " onClick={() => handleItemClick('customers')}>
                                                            <p className="side-text ">customers</p>
                                                        </Link>
                                                    </li>
                                                    <li className={`${activeItem === 'cInvoice' ? 'active-sub-link' : ''} ${pathname === '/cInvoice' ? 'active-sub-link' : ''}`}>
                                                        <Link to="/cInvoice"
                                                            className="side-link"
                                                    ...
                                                    <li className={`${activeItem === 'ReverseCustomerI' ? 'active-sub-link' : ''}  ${pathname === '/ReverseCustomerI' ? 'active-sub-link' : ''}`}>
